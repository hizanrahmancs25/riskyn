...
demoSnapshot.summary = {
  eal_inr: demoSnapshot.processes.reduce((total, process) => total + process.eal_inr, 0),
  process_count: demoSnapshot.processes.length,
  asset_count: demoSnapshot.processes.reduce((total, process) => total + process.assets, 0),
};
